...
class LoginPage(BasePage):
    ...
    def navigate_to_login_page(self):
        # 광고 닫기
        self.click(MusinsaLoginPageLocators.stop_watching_button_id, raise_exception=False)
        # 마이페이지 버튼 클릭
        self.click(MusinsaLoginPageLocators.mypage_button_id)
        # 로그인/회원가입하기 텍스트 클릭
        self.click(MusinsaLoginPageLocators.login_singup_text_xpath)

    def get_content_popup(self):
        return self.find_element(MusinsaLoginPageLocators.content_popup_id)  
